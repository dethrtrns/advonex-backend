...
import { statesWithCities } from '../src/data/locationData';
...
async function main() {
  ...
  //        cities: {
  //          create: state.state.cities.map((city) => ({
  //            name: city,
  //          })),
  //        },
  //        country: {
  ...
  //      },
  //    });
  //   console.log(`Created state: ${state.state.name} with cities: ${state.state.cities.join(', ')}`);
  // }
